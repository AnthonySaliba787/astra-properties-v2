function AboutModal({ activateAboutModal }) {
  return (
    <>
      <div className="w-full min-h-screen fixed mx-auto flex flex-col justify-center items-center bg-black/40 backdrop-blur-xl z-20 px-4 py-4">
        <div className="max-w-2xl bg-black/80 rounded-md shadow-md py-4 px-4 flex flex-col justify-center items-center text-center text-neutral-200">
          ...
          <p className="lg:text-lg px-4 py-4">
            At Astra Properties, we believe in turning your real estate dreams
            into reality. Whether you're looking for a place to call home or an
            investment opportunity, our dedicated team is here to guide you
